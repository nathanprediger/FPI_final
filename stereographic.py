...
if __name__ == "__main__":
    ...
    image = cv2.imread("imagens/teste2.jpg")[::4, ::4, :]
    ...
    plt.axis("off")
    plt.show()
    mesh_uniform, mesh_stereo = get_uniform_stereo_mesh(image, np.pi*97/180,4,10)
    print(mesh_stereo.shape, mesh_uniform.shape)